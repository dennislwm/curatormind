...
### An analogy of [n8n.io](https://n8n.io/dashboard) is DockerHub, as it is a repository of workflows. We have to host our own n8n server in order to create a workflow, and the easiest way is to install caprover.
