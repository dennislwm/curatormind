...
#### SQ 5.62%
#### CRSP 5.59%
### In conclusion, Finnhub.io API data is incorrect #TF. From a management perspective, it is more reliable to scrape data from a reputable website than using third-party financial API data.
